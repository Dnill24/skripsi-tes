const locales = {
  en: {
    ...
    plc_hero: "e.g. Hero",
    plc_enter_code: "Enter Code",

    // Skins
    skin_hero_name: "Hero", skin_hero_desc: "The standard hero.",
    ...
    skin_knight_name: "Knight", skin_knight_desc: "Swift and deadly.",
    skin_wizard_name: "Wizard", skin_wizard_desc: "Mystical powers.",
    skin_glow_name: "Fairy", skin_glow_desc: "A mystical forest spirit.",
    skin_ninja_name: "Ninja", skin_ninja_desc: "Swift and silent.",
    skin_robot_name: "Robot", skin_robot_desc: "Futuristic combat armor.",
    ...
    skin_angel_name: "Angel", skin_angel_desc: "Divine presence.",
    ...
    txt_start_countdown: "START!",
    txt_yes: "YES",
    txt_no: "NO",
    txt_you_win: "VICTORY!",
    txt_you_lose: "DEFEAT!",
    txt_versus_win_msg: "You won the match!",
    txt_versus_lose_msg: "You lost the match.",
    ...
    txt_opponent_fled: "Opponent Fled!",
    btn_opponent_left: "Opponent Left",
    txt_opponent_left_room: "Your opponent has left the room.",
    txt_opponent_forfeited: "Opponent Forfeited!",
    txt_room_full: "Room not found or already full!",
    txt_enter_room_code: "Enter a room code!",
    modal_grade_title: "Select Your Grade",
    modal_grade_desc: "This sets the initial difficulty of the math questions.",
    btn_grade_1: "1st Grade",
    btn_grade_2: "2nd Grade",
    btn_grade_3: "3rd Grade",
    btn_grade_higher: "Higher",
    modal_shop: "🛒 Skins",
    gold_label: "Gold: ",
    btn_close: "Close",
    ...
    title_hub: "Base Camp",
    title_subtitle: "An Epic Math RPG",
    rank_iron: "🪨 Iron",
    rank_bronze: "🥉 Bronze",
    rank_silver: "🥈 Silver",
    rank_gold: "🥇 Gold",
  ...
  id: {
    ...
    plc_enter_code: "Masukkan Kode",

    // Skins
    skin_hero_name: "Pahlawan", skin_hero_desc: "Pahlawan standar.",
    ...
    skin_knight_name: "Ksatria", skin_knight_desc: "Cepat dan mematikan.",
    skin_wizard_name: "Penyihir", skin_wizard_desc: "Kekuatan ajaib.",
    skin_glow_name: "Peri", skin_glow_desc: "Roh hutan mistis.",
    skin_ninja_name: "Ninja", skin_ninja_desc: "Cepat dan sunyi.",
    skin_robot_name: "Robot", skin_robot_desc: "Baju besi tempur masa depan.",
    ...
    txt_start_countdown: "MULAI!",
    txt_yes: "YA",
    txt_no: "TIDAK",
    txt_you_win: "MENANG!",
    txt_you_lose: "KALAH!",
    txt_versus_win_msg: "Kamu memenangkan pertandingan!",
    txt_versus_lose_msg: "Kamu kalah dalam pertandingan.",
    ...
    txt_opponent_fled: "Lawan Kabur!",
    btn_opponent_left: "Lawan Pergi",
    txt_opponent_left_room: "Lawanmu telah meninggalkan ruangan.",
    txt_room_full: "Ruangan tidak ditemukan atau sudah penuh!",
    txt_opponent_forfeited: "Lawan Menyerah!",
    txt_enter_room_code: "Masukkan kode ruangan!",
    modal_grade_title: "Pilih Kelasmu",
    modal_grade_desc: "Ini menentukan tingkat kesulitan awal soal matematika.",
    btn_grade_1: "Kelas 1",
    btn_grade_2: "Kelas 2",
    btn_grade_3: "Kelas 3",
    btn_grade_higher: "Lebih Tinggi",
    modal_shop: "🛒 Kostum",
    gold_label: "Emas: ",
    btn_close: "Tutup",
    ...
    title_hub: "Markas",
    title_subtitle: "RPG Matematika Epik",
    rank_iron: "🪨 Besi",
